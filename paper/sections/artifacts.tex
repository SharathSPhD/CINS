...
A deployed web application exposes the method to a reader who does not want to
install anything. It is a Python service wrapping the engine, with a
browser front end, and it offers four views. \emph{Analyse} runs a direct
...
A project site presents the method as a narrative walkthrough, from the
