...
and should not be read as independent evidence of accuracy. It is not vacuous,
however: Section~\ref{sec:ablations} reports a deliberately mis-sampled
configuration in which the same check \emph{fails}, at
$\Delta c_l = 7.6\x10^{-3}$, because the solve settled on a genuinely different
aerofoil. Realisability,
