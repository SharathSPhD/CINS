...
coefficients with their natural negative sign, SPEC.md~\S2.1)
...
\item \textbf{Manifest scheme.} Every experiment run in this paper writes
  ...
  (\pth{docs/GATES.md} condition~4). No number in this paper is
...
\item \textbf{Gate-closure evidence.} \pth{docs/gates/T2-closure.md},
  \texttt{T3-closure.md}, \texttt{T4-T7-closure.md} record the six-condition
  gate-closure contract (\pth{docs/GATES.md}) for each corresponding
  task, including adversarial-review findings and their resolution;
  \pth{docs/adr/ADR-0001} through \texttt{ADR-0004} record the four
