...
(\texttt{configs/experiments/panel\_uiuc/*.yaml}), leaving 117 cells.
Results are in \texttt{experiments/results/t8/uiuc\_panel\_summary.json},
...
(\texttt{vendor/mfoil/mfoil.py}, \texttt{build\_wake}) after the
